// this script creates the event cards for study tours and inserts them into a container element
// just insert the correct element id for the container element
...
var studyToursContainer = document.getElementById("div_block-3-701");
...
for (let i = 0; i < response.length; i++) {
  ...
  if (response[i].Event_Type__c === "Study Tour") {
