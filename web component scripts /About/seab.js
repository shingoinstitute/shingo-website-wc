// this script creates profile cards for the seab members and inserts them into a
// container element, just insert the id of the container element below
...
var response = httpGet("https://shingo-website-wc.herokuapp.com/api/seab");
var members = response;
var seabContainer = document.getElementById("ELEMENT ID"); // INSERT ID HERE***
seabContainer.style.display = "inline-block";
...
for (let i = 0; i < members.length; i++) {
  ...
  memberContainer.addEventListener("click", function() {
    ...
    var member = httpGet(
      "https://shingo-website-wc.herokuapp.com/api/seab/" + members[i].Id
    );
    console.log(member);
...
seabContainer.appendChild(memberProfile);
seabContainer.appendChild(membersMainContainer);
