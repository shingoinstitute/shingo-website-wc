// this script builds out all the workshop cards and inserts them into a
// container element. To use, just input the correct element id of the
// element you would like to insert the cards into.
