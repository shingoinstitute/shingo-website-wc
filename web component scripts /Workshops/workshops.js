...
for(let i = 0; i < workshops.length; i++) {
  ...
  workshopCard.style.backgroundPositionY = "265px";
  ...
  if(workshops[i].Workshop_Type__c === "Discover Excellence") {
    workshopCard.style.backgroundImage = "url(https://res.cloudinary.com/shingo/image/upload/v1582927002/Web%20Content/workshop%20icons/DiscoverButton.png)";
  }
  else if(workshops[i].Workshop_Type__c === "Systems Design") {
    workshopCard.style.backgroundImage = "url(https://res.cloudinary.com/shingo/image/upload/v1582927002/Web%20Content/workshop%20icons/SystemsButton.png)";
  }
  else if(workshops[i].Workshop_Type__c === "Cultural Enablers") {
    workshopCard.style.backgroundImage = "url(https://res.cloudinary.com/shingo/image/upload/v1582927002/Web%20Content/workshop%20icons/EnableButton.png)";
  }
  else if(workshops[i].Workshop_Type__c === "Continuous Improvement") {
    workshopCard.style.backgroundImage = "url(https://res.cloudinary.com/shingo/image/upload/v1582927002/Web%20Content/workshop%20icons/ImproveButton.png)";
  }
  else if(workshops[i].Workshop_Type__c === "Enterprise Alignment") {
    workshopCard.style.backgroundImage = "url(https://res.cloudinary.com/shingo/image/upload/v1582927002/Web%20Content/workshop%20icons/AlignButton.png)";
  }
  else if(workshops[i].Workshop_Type__c === "Build Excellence") {
    workshopCard.style.backgroundImage = "url(https://res.cloudinary.com/shingo/image/upload/v1582927002/Web%20Content/workshop%20icons/BuildButton.png)";
  }
  ...
  infoContainer.style.height = "300px";
  ...
  // eventLocation.innerHTML = workshops[i].Event_City__c + ", " + workshops[i].Event_Country__c;
  if(workshops[i].Event_City__c !== null) {
     eventLocation.innerHTML = workshops[i].Event_City__c;
  }
  if(workshops[i].Event_Country__c !== null) {
     eventLocation.innerHTML += (", " + workshops[i].Event_Country__c);
  }
  ...
  hostSiteTitle.style.margin = "5px 0px 0px 0px";
  ...
  affiliateTitle.style.margin = "5px 0px 0px 0px";
  ...
  affilaiteName.style.margin = "0px 0px 8px 0px";
